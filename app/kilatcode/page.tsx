'use client';
/**
 * KilatCode - Project List
 * 
 * Redirects to a new project or lists existing projects
...
export default function KilatCodeIndexPage() {
    ...
    useEffect(() => {
        if (!loading) {
            if (!user) {
                ...
                router.push(`/kilatcode/c/${projectId}`);
            }
        }
